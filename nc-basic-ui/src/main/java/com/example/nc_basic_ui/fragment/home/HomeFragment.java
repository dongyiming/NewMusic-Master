...
import com.example.nc_basic_biz.utils.WindowUtils;
...
public class HomeFragment extends BaseFragment {
    ...
    public View setRootView(LayoutInflater inflater) {
        ...
        //commonbar.setSearchVisible();
        //设置背景和状态栏
        commonbar.setBackgroundColor(getActivity().getResources().getColor(R.color.color_bg_toolbar_white));
        getActivity().getWindow().setStatusBarColor(getActivity().getResources().getColor(R.color.color_bg_toolbar_white));
        WindowUtils.setMiuiStatusBarDarkMode(getActivity(), true);
        return view;
    }
