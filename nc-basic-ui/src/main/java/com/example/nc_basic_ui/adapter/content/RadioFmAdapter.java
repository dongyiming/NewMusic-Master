 ...
 */
public class RadioFmAdapter {

    private RecyclerView recyclerView;
    private Context mContext;

    public RadioFmAdapter(final Context mContext, final List<MenuInfo> menuInfos) {
        ...
        recyclerView.setAdapter(new MultiCommonAdapter<MenuInfo>(mContext, menuInfos, new ICommonRecyclerListener<MenuInfo>() {
            ...
            public int getItemViewType(int position) {
                ...
                return position == 0 ? 999 : MenuType.RAD_FM.getValue();
            }
            ...
            public void convert(BaseViewHolder holder, MenuInfo menuInfo, int position, int type) {
                ...
                if (type == 999) {
                    holder.setText(R.id.txt_title, MenuType.RAD_FM.getName());
                } else {
