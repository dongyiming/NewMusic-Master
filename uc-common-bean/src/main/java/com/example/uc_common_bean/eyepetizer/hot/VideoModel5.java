 ...
 */
public class VideoModel5 {

    private String category;//预告
    private boolean collected;
    private Consumption consumption;
    private VideoModel4Cover cover;
    ...
    public static class VideoModel4Cover {
    ...
    public VideoModel4Cover getCover() {
        return cover;
    }

    public void setCover(VideoModel4Cover cover) {
        this.cover = cover;
    }
